...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      // ✅ حماية النظام بدل optional chaining
      if (!settingsSystem || typeof settingsSystem.getSettings !== "function") {
        return interaction.reply({
          content: "❌ نظام settings غير متوفر",
          ephemeral: true
        })
      }
      ...
      console.error("SETTINGS_COMMAND_ERROR", error)
