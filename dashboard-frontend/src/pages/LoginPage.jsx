...
export default function LoginPage() {
  ...
  return (
    <div className="rounded-3xl lyn-glass p-8 lyn-glow animate-lyn-fade-up">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2 lyn-text-gradient">مرحباً بعودتك</h1>
      ...
      <button
        ...
        disabled={loading}
        className="w-full py-3.5 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
      >
        {loading ? (
