...
READY FOR PHASE 3 (REAL LEARNING)
...
The system will transition from:

STATIC LEARNING → REAL FEEDBACK-DRIVEN LEARNING
...
PHASE 3 → SELF-LEARNING LOOP (REAL LEARNING SYSTEM)
...
FULL_AI_STACK + AUTONOMOUS + SOCIAL_GRAPH + PERSONALITY  
...
EVOLUTION COMPLETE → READY FOR PHASE 3 (REAL LEARNING)
...
PHASE 3 — SELF LEARNING LOOP (IN PROGRESS)
...
1. Real Learning System (Feedback-based learning)  
...
## CORE LAW
THIS PROJECT IS A SINGLE EVOLVING SYSTEM

---

## 🔒 ZERO DELETION RULE
- DO NOT delete any working code
...
## ✅ ADDITIVE ONLY
- ONLY add new logic
- ONLY extend existing systems
- ONLY improve safely

---

## 🚫 FORBIDDEN
- no refactoring stable systems
- no rewriting large sections
- no replacing implementations
- no reducing file size

---

## 📦 FILE RULE
- ALWAYS return FULL file
- file must be READY to copy-paste
- DO NOT return partial edits

---

## 🧠 CONTEXT RULE
- respect all existing systems
