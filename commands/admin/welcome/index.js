...
module.exports = {
  ...
  helpMeta: {
    category: "welcome",
    description: "نظام الترحيب بالأعضاء الجدد مع رسائل وصور مخصصة",
    subcommands: {
      "ضبط": {
        description: "ضبط إعدادات الترحيب (القناة، الرسالة، الصورة)",
        examples: [
          "/ترحيب ضبط القناة:#welcome الرسالة:أهلاً بك في السيرفر!",
          "/ترحيب ضبط القناة:#welcome الرسالة:مرحباً [user] في [server] الصورة:✅ مفعّل"
        ],
        notes: [
          "يدعم placeholders: [user] = ذكر العضو، [server] = اسم السيرفر، [count] = عدد الأعضاء",
          "الصورة المخصصة تظهر مع صورة العضو الشخصية وعدد الأعضاء"
        ]
      },
      "تفعيل": {
        description: "تفعيل نظام الترحيب (يحتاج ضبط الإعدادات أولاً)",
        examples: ["/ترحيب تفعيل"]
      },
      "إيقاف": {
        description: "إيقاف نظام الترحيب (الإعدادات تُحفظ)",
        examples: ["/ترحيب إيقاف"]
      },
      "حالة": {
        description: "عرض الإعدادات الحالية للترحيب",
        examples: ["/ترحيب حالة"]
      },
      "اختبار": {
        description: "اختبار رسالة الترحيب (تُرسل لك كعضو مفترض)",
        examples: ["/ترحيب اختبار"],
        notes: ["مفيد للتأكد من شكل الرسالة قبل دخول أعضاء جدد"]
      }
    },
    requirements: {
