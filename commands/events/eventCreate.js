...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(o =>
      o.setName("موعد_الانتهاء").setDescription("موعد انتهاء الفعالية (اختياري)").setRequired(false)
    )
    .addRoleOption(o =>
  ...
  async execute(interaction) {
    try {
      ...
      if (!allowed) {
        return interaction.reply({ content: "❌ ما عندك صلاحية إنشاء فعاليات.", ephemeral: true })
      }
