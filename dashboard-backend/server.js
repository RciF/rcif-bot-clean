...
const ownerServersRoutes = require("./routes/ownerServers")
const ownerPlayersRoutes = require("./routes/ownerPlayers")
...
app.use("/api", ownerServersRoutes)
app.use("/api", ownerPlayersRoutes)
...
app.use("/api/guild/:guildId", bulkRoutes)
